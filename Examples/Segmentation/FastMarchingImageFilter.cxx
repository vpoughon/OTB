...
// the edges of a particular structure. This should result in large
...
int main(int argc, char *argv[])
{
  if (argc < 10)
    ...
    std::cerr <<
    " Sigma SigmoidAlpha SigmoidBeta TimeThreshold StoppingValue" << std::endl;
    return 1;
    }
  ...
  //  and the value should decay rapidly to $0.0$
  ...
  //  minimum value along the contour of the structure to be
  ...
  //  for segmenting some structures shown in
  ...
  //
  // \begin{figure} \center
  // \includegraphics[height=0.30\textwidth]{QB_Suburb.eps}
  // \includegraphics[height=0.30\textwidth]{FastMarchingFilterOutput1.eps}
  // \includegraphics[height=0.30\textwidth]{FastMarchingFilterOutput2.eps}
  // \includegraphics[height=0.30\textwidth]{FastMarchingFilterOutput3.eps}
  ...
  // right: segmentation of the road, shadow, building.}
