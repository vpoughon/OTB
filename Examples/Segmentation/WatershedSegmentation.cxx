...
//
// \begin{figure} \center
// \includegraphics[width=0.32\textwidth]{ROI_QB_MUL_3.eps}
...
// \itkcaption[Watershed segmentation output]{Segmented RGB image.  At left is the original image.  The
...
// scale.
//
// Figure~\ref{fig:outputWatersheds} shows output from the example code. Note that a critical difference between the two
