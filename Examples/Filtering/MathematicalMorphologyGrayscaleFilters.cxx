...
//  \doxygen{itk}{GrayscaleErodeImageFilter} and
//  \doxygen{itk}{GrayscaleDilateImageFilter} are covered in this example. The
...
int main(int argc, char * argv[])
{
  ...
  //  \doxygen{itk}{NeighborhoodOperator}. In particular, the default
  //  structuring element is the
  //  \doxygen{itk}{BinaryBallStructuringElement} class. This class is
  //  instantiated using the pixel type and dimension of the input
  //  image.
  //
  //  Software Guide : EndLatex
  ...
  //  Software Guide : BeginLatex
  //
  //  A grayscale image is provided as input to the filters. This
  //  image might be, for example, the output of a reader.
  //
  //  Software Guide : EndLatex
  ...
  // \end{figure}
  //
  //  Figure \ref{fig:MathematicalMorphologyGrayscaleFilters}
  //  illustrates the effect of the erosion and dilation filters. The
  //  figure shows how these operations can be used to remove spurious
  //  details from segmented images.
  //
  //  Software Guide : EndLatex
