...
// ITK/OTB.  It should be read as a "Hello World" for registration. Which
...
//
// \index{otb::Image!Instantiation}
// \index{otb::Image!Header}
//
...
int main(int argc, char *argv[])
{
  ...
  //  \index{otb::Image!GetBufferedRegion()}
  //
  //  Software Guide : EndLatex
  ...
  //  will take a step along the direction of the \doxygen{itk}{ImageToImageMetric}
  ...
  //  Software Guide : BeginLatex
  //
  //  In the case of the \doxygen{itk}{TranslationTransform}, there is a
  ...
  // \includegraphics[width=0.44\textwidth]{QB_Suburb13x17y.eps}
  ...
  //  transform decorated in the form of a \doxygen{itk}{DataObject}. For details in
  //  this construction you may want to read the documentation of the
  //  \doxygen{itk}{DataObjectDecorator}.
  //
  ...
  //  image in a file. An \doxygen{itk}{CastImageFilter} is used to convert the
  ...
  //  using the \doxygen{itk}{SubtractImageFilter}. This pixel-wise filter computes
  ...
  //  \doxygen{itk}{RescaleIntensityImageFilter} in order to make them more visible.
