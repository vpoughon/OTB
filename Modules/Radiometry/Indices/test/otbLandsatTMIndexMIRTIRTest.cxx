...
int otbLandsatTMIndexMIRTIR(int itkNotUsed(argc), char * argv[])
{
  ...
  typedef otb::Functor::LandsatTM::MIRTIR<InputPixelType, OutputPixelType> FunctorType;

  FunctorType mirtirFunct = FunctorType();
  ...
  double goodResult = 255*(1-TM5)*(TM62+100)/100.;
  ...
  double result = mirtirFunct(pixel);
