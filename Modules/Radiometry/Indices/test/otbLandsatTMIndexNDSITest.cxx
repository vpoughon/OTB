...
int otbLandsatTMIndexNDSI(int itkNotUsed(argc), char * argv[])
{
  ...
  typedef otb::Functor::LandsatTM::NDSI<InputPixelType, OutputPixelType> FunctorType;

  FunctorType ndsiFunct = FunctorType();
  ...
  double goodResult = (TM2-TM5)/(TM2+TM5+ndsiFunct.GetEpsilonToBeConsideredAsZero());
